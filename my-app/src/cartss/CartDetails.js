...
import { addToCart,removeToCart,removeSingleItem,emptyCartIteams } from '../redux/app/features/cartSlice';
...
const CartDetails = () => {
    ...
    const makePayment= async()=>{
        const stripe= await loadStripe("pk_test_51O4KVKSJSW3kw8aK39qZv10g7KOhK6b4QbtwDYzgdTGl7Ig6FTggDbi5YE6MWgquGQ4k4w0eHdgvjVswI88inZx900dlMvLKjq");
                    ...
                    <div className="card1">
                        <div className="card-header bg-dark p-3">
                            <div className='card-header-flex'>
                                <h5 className='text-white m-0'>Mobile store {carts.length >0 ? `(${carts.length})`:""}</h5>
                                {
                                                    ...
                                                    return (
                                                        <>
                                                            <tr>
                                                                ...
                                                                <td><div className='product-name'><p>{data.category}</p></div></td>
                                                                <td>{data.price}</td>
                                                                <td>
